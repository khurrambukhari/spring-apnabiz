...
import com.krobusiness.model.dto.HobbyInfoDto;
import com.krobusiness.model.dto.HobbyInfoUpdateDto;
import com.krobusiness.model.entities.*;
import com.krobusiness.model.repostiory.HobbyRepository;
import com.krobusiness.service.CategoryService;
...
public class HobbyController {
    ...
    public List<Hobby> getHobbiesByLocation(@PathVariable Location location) {
    return	hobbyrepo.findAllByLocation(location);
    }
     
    @GetMapping("category/{category}")
    public List<Hobby> getHobbiesByCategories(@PathVariable Category category) {
    return	hobbyrepo.findAllByCategory(category);
    }
